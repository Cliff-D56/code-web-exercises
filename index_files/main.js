...
function renderCoffee(coffee) {
    var html = '<ul class="coffee" id="coffee" style="list-style: none">';
    html += '<li style="font-size: 50px" class="coffeeName">' + coffee.name + '</li>';
    html += '<li class="coffeeRoast">' + coffee.roast + '</li>';
    html += '</ul>';
